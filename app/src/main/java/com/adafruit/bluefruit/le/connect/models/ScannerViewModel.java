...
public class ScannerViewModel extends AndroidViewModel implements BleScanner.BleScannerListener {
    ...
    private LiveData<String> mRssiFilterDescription = Transformations.map(mRssiFilterValue, rssi -> String.format(Locale.ENGLISH, "TODO: scanner_filter_rssivalue_format" /*getApplication().getString(R.string.scanner_filter_rssivalue_format)*/, rssi));
    ...
    private LiveData<String> mFiltersDescription = Transformations.map(mFiltersLiveDataMerger, input -> {
        ...
        return filtersDescription != null ? String.format(Locale.ENGLISH, "TODO: scanner_filter_currentfilter_format"/*getApplication().getString(R.string.scanner_filter_currentfilter_format)*/, filtersDescription) : "TODO: scanner_filter_nofilter" /*getApplication().getString(R.string.scanner_filter_nofilter)*/;
    });
    ...
    private class FilterData {
        ...
        String getDescription() {
            ...
            if (rssi > FilterData.kMaxRssiValue) {
                String rssiString = String.format(Locale.ENGLISH, "TODO: scanner_filter_rssi_description_format" /*getApplication().getString(R.string.scanner_filter_rssi_description_format)*/, rssi);
            ...
            if (!isUnnamedEnabled) {
                String namedString = "TODO: scanner_filter_unnamed_description" /*getApplication().getString(R.string.scanner_filter_unnamed_description)*/;
                if (filtersTitle != null && !filtersTitle.isEmpty()) {
            ...
            if (isOnlyUartEnabled) {
                String uartString = "TODO: scanner_filter_uart_description"; //getApplication().getString(R.string.scanner_filter_uart_description);
                if (filtersTitle != null && !filtersTitle.isEmpty()) {
            ...
            if (blePeripheral != null) {
                if (BlePeripheral.kBlePeripheral_OnConnected.equals(action)) {
                    ...
                    blePeripheral.discoverServices(status -> {
                        ...
                        final Runnable discoveredServicesRunnable = () -> {
                            ...
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                final String message = "TODO: peripheraldetails_errordiscoveringservices"; //LocalizationManager.getInstance().getString(getApplication(), "peripheraldetails_errordiscoveringservices");
                    ...
                    if (mPeripheralsDiscoveringConnectingOrDiscoveringServices.contains(identifier)) {          // If connection setup was still ongoing
                        ...
                        if (!isExpected) {
                            final String message = "TODO: bluetooth_connecting_error"; //LocalizationManager.getInstance().getString(getApplication(), "bluetooth_connecting_error");
                            mBlePeripheralsConnectionErrorMessage.setValue(message);
                        }
